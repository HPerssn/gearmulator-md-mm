...
namespace mdJucePlugin
{
	const std::array<KeyboardMapping, g_keyboardMappingCount>& defaultKeyboardMappings()
	{
		...
		{{
			...
			{ Rml::Input::KI_TAB,    juce::KeyPress::tabKey,        md::PanelControl::Kit         },
			{ Rml::Input::KI_OEM_PLUS, '=',                         md::PanelControl::Stop        },
			{ Rml::Input::KI_OEM_MINUS, '-',                        md::PanelControl::Play        },
			{ Rml::Input::KI_0,      '0',                           md::PanelControl::Record      },
			{ Rml::Input::KI_OEM_PERIOD, '.',                       md::PanelControl::SynthesisEffectsRouting, md::PanelControl::DataPageForward },
			{ Rml::Input::KI_A,      'A',                           md::PanelControl::BankA       },
			{ Rml::Input::KI_S,      'S',                           md::PanelControl::BankB       },
			{ Rml::Input::KI_D,      'D',                           md::PanelControl::BankC       },
			{ Rml::Input::KI_F,      'F',                           md::PanelControl::BankD       },
			...
			{ Rml::Input::KI_OEM_COMMA, ',',                        md::PanelControl::DataPageBackward, md::PanelControl::SynthesisEffectsRouting },
			{ Rml::Input::KI_OEM_2,  '/',                           md::PanelControl::Tempo       },
